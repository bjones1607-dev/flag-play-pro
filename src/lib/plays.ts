...
export const PRESET_PLAYS: Play[] = [
  ...
  },
  {
    ...
    qb: QB,
    formation: "Empty",
    purpose: "Quick flip to the center; slants drag the short defenders inside (no blocking).",
    keyRead: "Throw it now. The slants pull coverage inside — catch and race to the edge.",
    tags: ["short", "screen"],
    receivers: [
      { id: "r1", ...POS.farLeft, route: "go", side: "left" },
      { id: "r2", ...POS.left, route: "slant", side: "left" },
  ...
  },
  {
    ...
    receivers: [
      ...
      { id: "r4", ...POS.slotLeft, route: "flat", side: "left" },
      { id: "r3", ...POS.center, route: "hitch", side: "right", isCenter: true },
  ...
  },
  {
    ...
    formation: "Trips Left",
    purpose:
      "Instant bubble screen — no blocking needed. The inside routes drag their defenders out of the runway and the zone flats play too deep to react.",
    keyRead: "Snap it, throw the popcorn to the wide side right away. Don't hold it.",
    notes:
      "No blocking in our league! Inside guys: sprint your routes and take your defender WITH you — that's how we clear the road. Runner: catch FIRST, then race the sideline.",
    tags: ["short", "screen", "zone-beater"],
    receivers: [
      { id: "r1", ...POS.farLeft, route: "screen", side: "left" },
      { id: "r2", ...POS.left, route: "slant", side: "left" },
      { id: "r4", ...POS.slotLeft, route: "drag", side: "left" },
      { id: "r3", ...POS.center, route: "delay", side: "right", isCenter: true },
      { id: "r5", ...POS.farRight, route: "go", side: "right" },
    ],
  },
  {
    ...
    receivers: [
      { id: "r1", ...POS.farLeft, route: "post", side: "left" },
      { id: "r3", ...POS.center, route: "sit", side: "right", isCenter: true },
      { id: "r2", ...POS.slotRight, route: "flat", side: "right" },
      { id: "r4", ...POS.right, route: "out", side: "right" },
      { id: "r5", ...POS.farRight, route: "go", side: "right" },
    ],
  },
  ...
  },
  {
    ...
    receivers: [
      { id: "r1", ...POS.farLeft, route: "go", side: "left" },
      { id: "r3", ...POS.center, route: "leak", side: "left", isCenter: true },
      { id: "r2", ...POS.slotRight, route: "screen", side: "right" },
      { id: "r4", ...POS.right, route: "hitch", side: "right" },
      { id: "r5", ...POS.farRight, route: "flat", side: "right" },
    ],
  },
  ...
  },
  {
    ...
    receivers: [
      { id: "r1", ...POS.farLeft, route: "go", side: "left" },
      { id: "r3", ...POS.center, route: "delay", side: "right", isCenter: true },
      { id: "r2", ...POS.slotRight, route: "drag", side: "right" },
      { id: "r4", ...POS.farRight, route: "sweep", side: "left", isRunner: true },
      { id: "r5", ...POS.backfield, route: "swing", side: "right" },
    ],
  },
  {
    id: "counter-trey",
  ...
  },
  {
    ...
    receivers: [
      ...
      { id: "r2", ...POS.left, route: "slant", side: "left" },
      { id: "r3", ...POS.center, route: "delay", side: "right", isCenter: true },
      { id: "r4", ...POS.farRight, route: "drag", side: "right" },
